...
public class FlingAnimation implements Animation {
    ...
    private com.herry.imagecompress.zoom.FlingAnimationListener listener;
    ...
    public void setListener(com.herry.imagecompress.zoom.FlingAnimationListener listener) {
