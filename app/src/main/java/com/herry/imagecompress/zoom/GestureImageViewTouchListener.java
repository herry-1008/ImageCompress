 ...
 */
package com.herry.imagecompress.zoom;
...
public class GestureImageViewTouchListener implements OnTouchListener {
    ...
    private com.herry.imagecompress.zoom.ZoomAnimation zoomAnimation;
    private com.herry.imagecompress.zoom.MoveAnimation moveAnimation;
    ...
    public GestureImageViewTouchListener(final GestureImageView image, int displayWidth, int displayHeight) {
        ...
        zoomAnimation = new com.herry.imagecompress.zoom.ZoomAnimation();
        moveAnimation = new com.herry.imagecompress.zoom.MoveAnimation();
        ...
        zoomAnimation.setZoomAnimationListener(new com.herry.imagecompress.zoom.ZoomAnimationListener() {
            @Override
        ...
        moveAnimation.setMoveAnimationListener(new com.herry.imagecompress.zoom.MoveAnimationListener() {
            ...
            if (event.getAction() == MotionEvent.ACTION_UP) {
                ...
                if (event.getPointerCount() > 1) {
                    ...
                    if (initialDistance > 0) {
                        ...
                        initialDistance = com.herry.imagecompress.zoom.MathUtils.distance(event);

                        com.herry.imagecompress.zoom.MathUtils.midpoint(event, midpoint);
