...
public class ZoomAnimation implements Animation {
    ...
    public com.herry.imagecompress.zoom.ZoomAnimationListener getZoomAnimationListener() {
        return zoomAnimationListener;
    }

    public void setZoomAnimationListener(com.herry.imagecompress.zoom.ZoomAnimationListener zoomAnimationListener) {
